...
import NoteBookByte as NoteBookByte
import NoteBookJson as NoteBookJson
import Sorter as Sorter
import CaloriesCounter as CaloriesCounter
...
dict_of_program = {
    "Address_book": AddressBook.main,
    "Note_book_byte": NoteBookByte.main,
    "Note_book_json": NoteBookJson.main,
    "Sorter": Sorter.main,
    "Calories_counter": CaloriesCounter.main
}
